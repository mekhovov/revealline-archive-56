#!/usr/bin/env python3
"""Configure dedicated archive-56 inventory from v0.87.0's original metadata."""
import hashlib
import json
...
VERSION = "v0.87.0"
SOURCE = "08548aeabe72f396fb75aede938d5bcadcfdc00e"
TREE = "6d85b9096d089b740a9eacf5e38eb5ebdfce5874"
TAG = "0217d8972b6deb1b18b5ea00a44488576a16d1b3"
ZIP = "4131bd0a0ec6a5cea5c12e4a81c4969c141c9a30ef28342ea53b032f18afa5ff"
ZIP_BYTES = 591074581
...
def main():
    ...
    assert qualification.stat().st_size == 14169 and sha(qualification.read_bytes()) == "038ddcc0741aa40cc0100f7384e47a03e549b3a96ef116dc3a5835c97b784147"
    ...
    lock = {
        "format": "revealline-archive-originals.v2", "archiveId": "archive-56", "repository": "mekhovov/revealline-archive-56",
    ...
    inventory = {"base": "https://mekhovov.github.io/revealline-archive-56/", "files": rows}
    ...
    assert original["id"] == 394195205 and original["tag_name"] == VERSION
    ...
    (ROOT / "input-authority.json").write_bytes(json_bytes({
        "version": VERSION, "releaseId": 394195205, "source": SOURCE, "tree": TREE, "tagObject": TAG,
        "donorCommit": "288aaa3fe195aa0bf04695816313afeb4cbe0033", "toolingCommit": TOOLING, "donorDeploymentMerge": "288aaa3fe195aa0bf04695816313afeb4cbe0033", "priorAcceptedPaths": 0,
